...
export default function EditRecipe() {
  ...
  const fileInputRef = useRef(null); // ref file inputille
  ...
  const handleRemoveImage = () => {
    ...
    if (fileInputRef.current) {
      fileInputRef.current.value = ''; // tyhjennetään file input
    }
  };
        ...
        {recipe.image && (
          <div className="relative inline-block">
            ...
            <button
              ...
              className="absolute top-1 right-1 bg-black/50 text-white rounded-full w-6 h-6 flex items-center justify-center hover:bg-black/70 transition cursor-pointer leading-none pb-[3px]"
              title="Poista kuva"
            >
              ×
            </button>
